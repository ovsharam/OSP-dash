...
import { EmptyCart } from "@/components/EmptyStateNew";
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <div className="text-right">
                      ...
                      {item.freightShipping && (
                        <div className="text-sm text-gray-500">
                          Freight: ${(item.freightShipping.amount / 100).toFixed(2)} via {item.freightShipping.carrier}
                        </div>
                      )}
                      {!item.freightShipping && item.selectedShipping && (
                        <div className="text-sm text-gray-500">
