...
function EquipmentContent() {
  ...
  // Filter products to only show Equipment category
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="ml-4 md:ml-8 lg:ml-12 2xl:ml-20 mr-4 md:mr-8 lg:mr-12 2xl:mr-20 pt-8 pb-4">
        ...
        {/* Title and Unlock Button */}
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-black">Wholesale soda equipment</h1>
          <button className="flex items-center gap-2 px-4 py-2 bg-black text-white rounded-md text-sm font-medium hover:bg-gray-800 transition-colors whitespace-nowrap">
        ...
        <h2 className="text-xl md:text-2xl font-normal text-gray-800 mb-6">
          Dive into our vast selection of soda equipment
        </h2>
      ...
      <div className="flex">
        ...
        {/* Product Grid */}
        <div className={`flex-1 pb-8 transition-all duration-300 ${showSidebarFilters ? 'ml-4 md:ml-8 lg:ml-12 2xl:ml-20 mr-4 md:mr-8 lg:mr-12 2xl:mr-20' : 'ml-4 md:ml-8 lg:ml-12 2xl:ml-20 mr-4 md:mr-8 lg:mr-12 2xl:mr-20'}`}>
