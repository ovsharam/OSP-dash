...
const categoryBrands = {
    ...
    "Functional Beverages": [
        { name: "Olipop", location: "Oakland, California", image: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=800" },
        { name: "Poppi", location: "Austin, Texas", image: "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=800" },
        { name: "Recess", location: "New York, New York", image: "https://images.unsplash.com/photo-1543253687-c59975c7125e?w=800" },
        { name: "Kin Euphorics", location: "Austin, Texas", image: "https://images.unsplash.com/photo-1527661591475-527312dd65f5?w=800" }
    ],
                ...
                <div className="max-w-[1280px] mx-auto px-6 md:px-10 lg:px-12 w-full">
                    ...
                    <div className="flex flex-wrap gap-3 mb-10">
                        {Object.keys(categoryBrands).map((cat) => (
                            <button
                                key={cat}
                                onClick={() => setActiveCategory(cat as keyof typeof categoryBrands)}
                        ...
                        <div className="w-full lg:w-1/2">
                            <div className="relative w-full aspect-[4/5] lg:aspect-[3/4] max-w-[500px] mx-auto lg:mx-0 lg:ml-auto">
                                <div className="relative w-full h-full rounded-sm overflow-hidden bg-gray-100">
                                    <Image alt="Sarah Jenkins stocking shelves" src="https://images.unsplash.com/photo-1556740758-9