                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-sm text-gray-500">
                        {isMounted ? review.date.toLocaleDateString() : review.date.toDateString()}
                      </span>
                    </div>
              ...
              <div key={question.id} className="border-b border-gray-100 pb-6 last:border-0">
                <div className="mb-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-sm text-gray-500">
                      {question.askedBy} • {isMounted ? question.askedDate.toLocaleDateString() : question.askedDate.toDateString()}
                    </span>
                  </div>
                  {question.answers.map((answer) => (
                    <div key={answer.id} className="ml-6 mt-3 p-3 bg-gray-50 rounded">
                      <div className="flex items-center space-x-2 mb-1">
                        ...
                        <span className="text-sm text-gray-500">
                          {isMounted ? answer.answeredDate.toLocaleDateString() : answer.answeredDate.toDateString()}
                        </span>
                      </div>
