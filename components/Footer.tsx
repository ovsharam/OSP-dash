...
export default function Footer() {
    ...
    // Don't show footer on login/signup pages if needed, but for now we show it everywhere
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link href="/browse?filter=new" className="text-base text-gray-500 hover:text-gray-900">
                                    New Arrivals
                                </Link>
                            </li>
                            <li>
                                <Link href="/browse?filter=featured" className="text-base text-gray-500 hover:text-gray-900">
                                    Featured
                                </Link>
                            </li>
                            <li>
                                <Link href="/browse?category=Sale" className="text-base text-gray-500 hover:text-gray-900">
                                    Sale
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="border-t border-gray-200 pt-8 mt-12 md:flex md:items-center md:justify-between">
                    ...
                    <div className="mt-8 md:mt-0 md:order-1">
                        <p className="text-base text-gray-400">
                            &copy; 2026 OSP Marketplace, Inc. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
